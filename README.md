...
This repository is a collection of fundamental algorithms and data structures I implemented in Python. It was built as a learning resource and a quick reference, to practice core computer science concepts.
...
| [**Hash Table**](data_structures/hash_table.py) | Stores data as key-value pairs. Uses a hash function to map keys to array indices for rapid lookups. | `O(1)`  | `O(1)` | `O(1)` |
